"""MyWorldAlbum URL Configuration
...
urlpatterns = [
    ...
    path('photographers/<str:author_slug>/update_password/', user_views.change_password, name="update_password"),
...
handler404 = 'album.views.error_404'
